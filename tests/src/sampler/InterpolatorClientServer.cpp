...
/*! \file InterpolatorClientServer.cpp 
 * \brief unit tests for sampler InterpolatorClientServer class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for sampler/InterpolatorClientServer" << endl;
...
/*! unit tests for src/sampler/InterpolatorClientServer */
int main(int argc, char * argv[])
{
	...
	UnitTest test("sampler/InterpolatorClientServer");
	test.start();
