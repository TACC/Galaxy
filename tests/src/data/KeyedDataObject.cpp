...
/*! \file KeyedDataObject.cpp 
 * \brief unit tests for data KeyedDataObject class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for data/KeyedDataObject" << endl;
...
/*! unit tests for src/data/KeyedDataObject */
int main(int argc, char * argv[])
{
	...
	UnitTest test("data/KeyedDataObject");
	test.start();
