...
/*! \file DataDrivenSpheres.cpp 
 * \brief unit tests for ospray DataDrivenSpheres class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for ospray/DataDrivenSpheres" << endl;
...
/*! unit tests for src/ospray/DataDrivenSpheres */
int main(int argc, char * argv[])
{
	...
	UnitTest test("ospray/DataDrivenSpheres");
	test.start();
