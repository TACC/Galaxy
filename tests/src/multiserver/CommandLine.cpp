 ...
 * \brief unit tests for multiserver CommandLine class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/CommandLine" << endl;
...
/*! unit tests for src/multiserver/CommandLine */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/CommandLine");
	test.start();
