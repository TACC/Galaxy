...
/*! \file DynamicLibraryManager.cpp 
 * \brief unit tests for multiserver DynamicLibraryManager class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/DynamicLibraryManager" << endl;
...
/*! unit tests for src/multiserver/DynamicLibraryManager */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/DynamicLibraryManager");
	test.start();
