...
/*! \file MultiServerHandler.cpp 
 * \brief unit tests for multiserver MultiServerHandler class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/MultiServerHandler" << endl;
...
/*! unit tests for src/multiserver/MultiServerHandler */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/MultiServerHandler");
	test.start();
