...
/*! \file MultiServerSocket.cpp 
 * \brief unit tests for multiserver MultiServerSocket class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/MultiServerSocket" << endl;
...
/*! unit tests for src/multiserver/MultiServerSocket */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/MultiServerSocket");
	test.start();
