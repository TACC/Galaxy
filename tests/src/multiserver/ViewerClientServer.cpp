...
/*! \file ViewerClientServer.cpp 
 * \brief unit tests for multiserver ViewerClientServer class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/ViewerClientServer" << endl;
...
/*! unit tests for src/multiserver/ViewerClientServer */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/ViewerClientServer");
	test.start();
