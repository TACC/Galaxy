...
/*! \file PingClientServer.cpp 
 * \brief unit tests for multiserver PingClientServer class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/PingClientServer" << endl;
...
/*! unit tests for src/multiserver/PingClientServer */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/PingClientServer");
	test.start();
