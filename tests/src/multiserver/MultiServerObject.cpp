...
/*! \file MultiServerObject.cpp 
 * \brief unit tests for multiserver MultiServerObject class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/MultiServerObject" << endl;
...
/*! unit tests for src/multiserver/MultiServerObject */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/MultiServerObject");
	test.start();
