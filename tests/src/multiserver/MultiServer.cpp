 ...
 * \brief unit tests for multiserver MultiServer class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/MultiServer" << endl;
...
/*! unit tests for src/multiserver/MultiServer */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/MultiServer");
	test.start();
