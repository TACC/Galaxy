 ...
 * \brief unit tests for multiserver SocketHandler class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/SocketHandler" << endl;
...
/*! unit tests for src/multiserver/SocketHandler */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/SocketHandler");
	test.start();
