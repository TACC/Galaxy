...
/*! \file ServerRendering.cpp 
 * \brief unit tests for multiserver ServerRendering class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/ServerRendering" << endl;
...
/*! unit tests for src/multiserver/ServerRendering */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/ServerRendering");
	test.start();
