 ...
 * \brief unit tests for multiserver ClientWindow class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/ClientWindow" << endl;
...
/*! unit tests for src/multiserver/ClientWindow */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/ClientWindow");
	test.start();
