...
/*! \file DataClientServer.cpp 
 * \brief unit tests for multiserver DataClientServer class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/DataClientServer" << endl;
...
/*! unit tests for src/multiserver/DataClientServer */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/DataClientServer");
	test.start();
