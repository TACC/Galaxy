 ...
 * \brief unit tests for multiserver JsonInterface class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for multiserver/JsonInterface" << endl;
...
/*! unit tests for src/multiserver/JsonInterface */
int main(int argc, char * argv[])
{
	...
	UnitTest test("multiserver/JsonInterface");
	test.start();
