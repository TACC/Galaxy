...
/*! \file VolumeVis.cpp 
 * \brief unit tests for renderer VolumeVis class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/VolumeVis" << endl;
...
/*! unit tests for src/renderer/VolumeVis */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/VolumeVis");
	test.start();
