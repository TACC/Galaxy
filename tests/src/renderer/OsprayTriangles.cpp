...
/*! \file OsprayTriangles.cpp 
 * \brief unit tests for renderer OsprayTriangles class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/OsprayTriangles" << endl;
...
/*! unit tests for src/renderer/OsprayTriangles */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/OsprayTriangles");
	test.start();
