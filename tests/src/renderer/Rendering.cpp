...
/*! \file Rendering.cpp 
 * \brief unit tests for renderer Rendering class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/Rendering" << endl;
...
/*! unit tests for src/renderer/Rendering */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/Rendering");
	test.start();
