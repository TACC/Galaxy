...
/*! \file ParticlesVis.cpp 
 * \brief unit tests for renderer ParticlesVis class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/ParticlesVis" << endl;
...
/*! unit tests for src/renderer/ParticlesVis */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/ParticlesVis");
	test.start();
