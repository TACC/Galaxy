...
/*! \file TraceRays.cpp 
 * \brief unit tests for renderer TraceRays class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/TraceRays" << endl;
...
/*! unit tests for src/renderer/TraceRays */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/TraceRays");
	test.start();
