...
/*! \file RayQManager.cpp 
 * \brief unit tests for renderer RayQManager class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/RayQManager" << endl;
...
/*! unit tests for src/renderer/RayQManager */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/RayQManager");
	test.start();
