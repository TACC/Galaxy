...
/*! \file RenderingEvents.cpp 
 * \brief unit tests for renderer RenderingEvents class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/RenderingEvents" << endl;
...
/*! unit tests for src/renderer/RenderingEvents */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/RenderingEvents");
	test.start();
