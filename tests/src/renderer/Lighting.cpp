...
/*! \file Lighting.cpp 
 * \brief unit tests for renderer Lighting class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/Lighting" << endl;
...
/*! unit tests for src/renderer/Lighting */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/Lighting");
	test.start();
