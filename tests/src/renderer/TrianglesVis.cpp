...
/*! \file TrianglesVis.cpp 
 * \brief unit tests for renderer TrianglesVis class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/TrianglesVis" << endl;
...
/*! unit tests for src/renderer/TrianglesVis */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/TrianglesVis");
	test.start();
