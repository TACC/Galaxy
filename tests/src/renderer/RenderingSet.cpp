...
/*! \file RenderingSet.cpp 
 * \brief unit tests for renderer RenderingSet class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/RenderingSet" << endl;
...
/*! unit tests for src/renderer/RenderingSet */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/RenderingSet");
	test.start();
