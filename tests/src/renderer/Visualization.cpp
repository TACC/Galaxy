 ...
 * \brief unit tests for renderer Visualization class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/Visualization" << endl;
...
/*! unit tests for src/renderer/Visualization */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/Visualization");
	test.start();
