...
/*! \file OsprayParticles.cpp 
 * \brief unit tests for renderer OsprayParticles class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/OsprayParticles" << endl;
...
/*! unit tests for src/renderer/OsprayParticles */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/OsprayParticles");
	test.start();
