...
/*! \file OsprayVolume.cpp 
 * \brief unit tests for renderer OsprayVolume class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/OsprayVolume" << endl;
...
/*! unit tests for src/renderer/OsprayVolume */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/OsprayVolume");
	test.start();
