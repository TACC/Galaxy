...
/*! \file OsprayUtil.cpp 
 * \brief unit tests for renderer OsprayUtil class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/OsprayUtil" << endl;
...
/*! unit tests for src/renderer/OsprayUtil */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/OsprayUtil");
	test.start();
