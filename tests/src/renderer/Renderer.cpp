...
/*! \file Renderer.cpp 
 * \brief unit tests for renderer Renderer class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/Renderer" << endl;
...
/*! unit tests for src/renderer/Renderer */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/Renderer");
	test.start();
