...
/*! \file MappedVis.cpp 
 * \brief unit tests for renderer MappedVis class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/MappedVis" << endl;
...
/*! unit tests for src/renderer/MappedVis */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/MappedVis");
	test.start();
