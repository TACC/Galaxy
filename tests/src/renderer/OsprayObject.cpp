...
/*! \file OsprayObject.cpp 
 * \brief unit tests for renderer OsprayObject class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for renderer/OsprayObject" << endl;
...
/*! unit tests for src/renderer/OsprayObject */
int main(int argc, char * argv[])
{
	...
	UnitTest test("renderer/OsprayObject");
	test.start();
