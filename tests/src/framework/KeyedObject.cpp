...
/*! \file KeyedObject.cpp 
 * \brief unit tests for framework KeyedObject class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for framework/KeyedObject" << endl;
...
/*! unit tests for src/framework/KeyedObject */
int main(int argc, char * argv[])
{
	...
	UnitTest test("framework/KeyedObject");
	test.start();
