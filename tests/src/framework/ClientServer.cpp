 ...
 * \brief unit tests for framework ClientServer class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for framework/ClientServer" << endl;
...
/*! unit tests for src/framework/ClientServer */
int main(int argc, char * argv[])
{
	...
	UnitTest test("framework/ClientServer");
	test.start();
