...
/*! \file Messaging.cpp 
 * \brief unit tests for framework Messaging class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for framework/Messaging" << endl;
...
/*! unit tests for src/framework/Messaging */
int main(int argc, char * argv[])
{
	...
	UnitTest test("framework/Messaging");
	test.start();
