...
/*! \file Threading.cpp 
 * \brief unit tests for framework Threading class
 * \ingroup unittest
 */
...
syntax(char *a)
{
  cerr << "unit tests for framework/Threading" << endl;
...
/*! unit tests for src/framework/Threading */
int main(int argc, char * argv[])
{
	...
	UnitTest test("framework/Threading");
	test.start();
