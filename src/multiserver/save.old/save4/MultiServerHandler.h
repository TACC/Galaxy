...
class MultiServerHandler
{
  typedef bool (*server_func)(MultiServerHandler*);

public:
  static MultiServerHandler *GetTheThreadMultiServerHandler();

  MultiServerHandler();
  MultiServerHandler(int cfd, int dfd);
  ...
  DynamicLibraryP GetTheDynamicLibrary() { return dlp; }
