...
#if 1
      // std::cerr << raylist->get_r(i) << " " << raylist->get_g(i) << " " << raylist->get_b(i) << " " << raylist->get_o(i) << "\n";
      float o = raylist->get_so(i);
      p->r = raylist->get_r(i) + (1.0 - o) * bkgnd.x;
      p->g = raylist->get_g(i) + (1.0 - o) * bkgnd.y;
      p->b = raylist->get_b(i) + (1.0 - o) * bkgnd.z;
      p->o = o;
#else
      p->r = raylist->get_r(i);
      p->g = raylist->get_g(i);
